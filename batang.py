...
def tampilkan_halaman():
    ...
    # Menambahkan tombol untuk menuju halaman satudata.tulungagung.go.id
        st.markdown("[Kunjungi Satu Data Tulungagung](https://satudata.tulungagung.go.id/)")
    ...
    if st.button("Pengertian"):
        ...
        st.text("Diagram batang merupakan representasi grafis data kuantitatif dalam bentuk \n batang-batang tegak atau mendatar. Panjang setiap batang merepresentasikan nilai \n data yang bersesuaian. Diagram batang efektif digunakan untuk membandingkan data \n kategorikal atau ordinal.")
